...
public class LoggerLog4J2Impl extends LoggerDefaultImpl {
    ...
    // Private Constants
    private static final String CALLING_CLASS_FQCN = LoggerLog4J2Impl.class
        .getName();
    ...
    @Override public void trace(String message, Object... arguments) {
    ...
    private void _logMessage(Level level, String message, Throwable throwable) {
        ...
        if (wrappedLogger instanceof ExtendedLogger) {
            ...
            extendedLogger.logMessage(CALLING_CLASS_FQCN, level, null,
                new SimpleMessage(message), throwable);
        } else {
            wrappedLogger.logMessage(level, MarkerManager.getMarker("LFU"),
                CALLING_CLASS_FQCN, null, new SimpleMessage(message),
                throwable);
        }
    }
}
