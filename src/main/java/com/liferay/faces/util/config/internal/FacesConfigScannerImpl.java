...
import com.liferay.faces.util.product.info.internal.ProductInfoMojarraImpl;
...
public class FacesConfigScannerImpl implements FacesConfigScanner {
	...
	public FacesConfig scan() throws IOException {
		...
		try {
			...
			// Since the FactoryExtensionFinder has not been initialized, create a new Mojarra ProductInfo manually,
			// to determine if Mojarra is present.
			final ProductInfo MOJARRA = new ProductInfoMojarraImpl();
