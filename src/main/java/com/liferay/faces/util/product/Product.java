...
public interface Product {
	 ...
	 */
	public enum Name {
		ANGULARBEANS, ANGULARFACES, BOOTSFACES, BUTTERFACES, CDI, CDI_API, CLOSURE_TEMPLATES, DELTASPIKE,
		GLASSFISH, HIGHFACES, ICEFACES, JETTY, JSF, JSF_API, LIFERAY_FACES_ALLOY, LIFERAY_FACES_BRIDGE,
		LIFERAY_FACES_BRIDGE_EXT, LIFERAY_FACES_CLAY, @Deprecated
		...
		RESIN, RICHFACES, SERVLET_API, SERVLET_CONTAINER, SPRING_FRAMEWORK, TOMCAT, WELD, WEBLOGIC, WEBSPHERE;
	}
