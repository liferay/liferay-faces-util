 ...
 * @author  Neil Griffin
 */
public class ProductInfoBaseImpl implements ProductInfo {

	// Logger
	private static final Logger logger = LoggerFactory.getLogger(ProductInfoBaseImpl.class);
	...
	protected final void init(Class<?> clazz, String expectedTitle) {
