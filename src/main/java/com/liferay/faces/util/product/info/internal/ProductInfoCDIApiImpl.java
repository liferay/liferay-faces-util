 ...
 * @author  Neil Griffin
 */
public class ProductInfoCDIApiImpl extends ProductInfoBaseImpl {

	// Logger
	private static final Logger logger = LoggerFactory.getLogger(ProductInfoCDIApiImpl.class);

	public ProductInfoCDIApiImpl() {
