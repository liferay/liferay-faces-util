 ...
 * @author  Neil Griffin
 */
public class ProductInfoJSFApiImpl extends ProductInfoBaseImpl {

	public ProductInfoJSFApiImpl(ProductInfo mojarra, ProductInfo myFaces) {

		this.title = "JSF API";

		ProductInfo jsfRuntime;
