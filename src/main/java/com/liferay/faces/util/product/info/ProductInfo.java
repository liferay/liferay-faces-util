...
public interface ProductInfo {
	 ...
	 */
	public enum Name {
		ANGULARBEANS, ANGULARFACES, BOOTSFACES, BUTTERFACES, CDI, CDI_API, CLOSURE_TEMPLATES, DELTASPIKE, GLASSFISH,
		HIGHFACES, ICEFACES, JETTY, JSF, JSF_API, LIFERAY_FACES_ALLOY, LIFERAY_FACES_BRIDGE, LIFERAY_FACES_BRIDGE_EXT,
		LIFERAY_FACES_CLAY, LIFERAY_FACES_PORTAL, LIFERAY_FACES_SHOWCASE, LIFERAY_FACES_UTIL, LIFERAY_PORTAL, MOJARRA,
